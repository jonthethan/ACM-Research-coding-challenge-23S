...
public class Main
 {
    public static void main(String[] args) throws Exception 
    {
        ...
        mostCommonType(type0Count, type1Count, type2Count, type3Count, type4Count, type5Count);
        fileS.close();
    }

    public static void mostCommonType(int type0Count, int type1Count, int type2Count, int type3Count, int type4Count, int type5Count)
    {
        int t[] = new int[6];
        t[0] = type0Count;
        t[1] = type1Count;
        ...
        {
            case 0:
                System.out.println("Most common Star Type: Brown Dwarf");
                break;
            case 1:
                System.out.println("Most common Star Type: Red Dwarf");
                break;
            case 2:
                System.out.println("Most common Star Type: White Dwarf");
                break;
            case 3:
                System.out.println("Most common Star Type: Main Sequence");
                break;
            case 4:
                System.out.println("Most common Star Type: Supergiant");
                break;
            default:
                System.out.println("Most common Star Type: Hypergiant");
        }
    }
